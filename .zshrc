...
source /home/ruslan/.zsh/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh

export HYPRSHOT_DIR="/home/ruslan/Screenshots"
...
__conda_setup="$('/mnt/Storage_500/miniconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/mnt/Storage_500/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/mnt/Storage_500/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/mnt/Storage_500/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
